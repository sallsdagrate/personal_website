window.SITE_CONFIG = {
  ...
  highlights: [
    ...
    "Imperial College London MEng Joint Mathematics and Computing graduate with First Class Honours.",
    "Experience spanning machine learning systems, market data pipelines, concurrency, CUDA, and end-to-end deployment."
  ]
};
